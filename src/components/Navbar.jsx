      ...
      <div className="container flex flex-wrap md:flex-nowrap items-center mx-auto">
        <div className=" md:hidden">
          <Link to={"/"} className="w-fit hover:brightness-110 transition-all">
            <span className="text-xl text-palette-Auburn  font-bol font-Cremona">
              B
              <img
        ...
        <Link
          to={"/"}
          className="hidden md:block w-fit hover:brightness-110 transition-all"
        >
          <img
        ...
        <div
          className="fixed w-full md:hidden left-0 bottom-0 p-4 bg-palette-OrchidPink z-50"
          id="navbar-default"
        >
          <ul className="flex justify-between  md:flex md:flex-row md:justify-evenly  md:bg-inherit">
            {links.map((el, i) => (
              <li key={i}>
                <Link
                  to={codeLinks[i]}
                  className={({ isActive }) => {
                    return (
                      "block py-2 pl-3 pr-4 text-xl text-gray-700" +
                      (!isActive
                        ? "underline underline-offset-0 decoration-4 md:underline-offset-8 decoration-palette-Auburn"
                        : "")
                    );
                  }}
                >
          ...
          <ul className="flex flex-col p-4 gap-6 border border-gray-700 rounded-lg md:flex md:flex-row md:justify-evenly md:border-0 md:bg-inherit">
            {links.map((el, i) => (
              <li key={i}>
                <Link
                  to={codeLinks[i]}
                  className="block py-2 pl-3 pr-4 text-xl text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:underline md:underline-offset-8 md:decoration-4 md:decoration-palette-Auburn  md:p-0 font-UrbanistMedium"
                >
                  {`${el}`}
                </Link>
              </li>
