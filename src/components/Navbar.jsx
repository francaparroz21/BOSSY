...
const Navbar = () => {
  ...
  return (
    <nav className='container my-5 sm:m-0 rounded border-gray-200 dark:bg-gray-900'>
      <div className='flex md:flex-nowrap md:items-center md:mx-auto'>
        <div className='block md:hidden'>
          <NavLink to='/' className='w-fit pl-5 hover:brightness-110 transition-all'>
            ...
            {svgLinks.map((el, i) => (
              <li key={i}>
                <NavLink
                  ...
                  className={({ isActive }) => {
                    return (
                      'block py-2 text-xl text-gray-700' +
                      (!isActive
