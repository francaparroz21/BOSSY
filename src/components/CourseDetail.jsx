  ...
  return (
    <div className='container grid gap-10 mb-10'>
        ...
        ? (
          <div>
            ...
            {item.topics.map((topic) => (
              <p key={topic[0]} className=' mx-16 font-Urbanist text-xl'>
                {topic}
              </p>
            ))}
          </div>
      ...
      {Check(item.certificate)
        ? (
          <>
            <p className=' mx-16 font-Urbanist text-xl'>{item.certificate}</p>
          </>
          )
        : (
            ''
      ...
      {Check(item.details)
        ? (
          <>
            <p className=' mx-16 font-Urbanist text-xl'>{item.details}</p>
          </>
          )
        : (
            ''
