...
export const ServiceCarousel = () => {
  const item = 
  <div class="flex grow self-center gap-4 bg-white border border-gray-200 rounded-lg shadow overflow-hidden dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
      <img class="rounded-t-lg w-[25rem]" src="/src/assets/static/imgproducts/protector_solar_ml_resize_x2_colored_toned_light_ai.jpg" alt="" />
    </a>
